  ...
  var h = function (e) {
    ...
    f = function () {
      ...
      return n.prototype.getHls = function () {
        ...
        if (n.addClass("vjs-quality-selector"), this.config.displayCurrentQuality) this.setButtonInnerText("auto");else {
        ...
        this._currentQuality = t, this.config.displayCurrentQuality && this.setButtonInnerText("auto" === t ? t : t + "p");
