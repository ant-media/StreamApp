...
var _soundmeter = require("./soundmeter.js");
/** 
  ...
  */
  ...
  enableAudioLevelWhenMuted() {
    navigator.mediaDevices.getUserMedia({
      ...
      const soundMeter = new _soundmeter.SoundMeter(this.audioContext);
  ...
  enableAudioLevelForLocalStream(levelCallback, period) {
    this.localStreamSoundMeter = new _soundmeter.SoundMeter(this.audioContext);
    this.connectSoundMeterToLocalStream();
  ...
  applyConstraints(newConstraints) {
    ...
    if (constraints.audio !== undefined) {
      ...
      promise = this.setAudioInputSource(streamId, {
        audio: this.mediaConstraints.audio
      }, null);
    }
    return promise;
