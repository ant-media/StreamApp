...
export class WebRTCAdaptor {
    ...
    takeConfiguration(idOfStream, configuration, typeOfConfiguration, idMapping) {
        ...
        // When we enable adaptive bitrate or just watching a stream using hls
        // iOS devices send a=extmap:13 urn:3gpp:video-orientation and a=extmap:4 urn:3gpp:video-orientation
        // in the sdp. This causes the video rotated wrongly. We need to remove these lines from the sdp.
        // Note: This is a workaround solution for now. It's also added in Android SDK, Flutter SDK and React Native SDK.
        // If the issue is fixed in the future, we can remove this code from all these SDK's.
        // Mustafa BOLEKEN 03.03.2024
